            ...
            <section className="container" style={{ paddingTop: '100px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '6rem', alignItems: 'start' }}>
                    ...
                    <div className="animate-pop-up">
                        ...
                        <h1 className="heading-serif" style={{ fontSize: '4.5rem', fontWeight: 700, lineHeight: 1, marginBottom: '4rem' }}>Let's start your <br /><span className="text-accent">Project</span></h1>
                        ...
                        <form style={{ display: 'grid', gap: '2.5rem' }}>
                            ...
                            <div className="form-group">
                                <label className="form-label" style={{ opacity: 0.5 }}>What project are you planning?</label>
