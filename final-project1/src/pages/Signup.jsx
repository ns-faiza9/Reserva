...
const Signup = () => {
    ...
    const handleSubmit = (e) => {
        ...
        signup(formData);
        alert("Account Established. Please login.");
        navigate('/login');
    };
    ...
    return (
        <div className="auth-container" style={{ background: 'var(--bg-color)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 2rem' }}>
            <div className="card" style={{ maxWidth: '600px', width: '100%', padding: '4rem', borderRadius: '40px' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '2.5rem', fontSize: '0.9rem' }}>
                    <p style={{ color: 'var(--text-muted)' }}>
                        Already have an ID? <a href="/login" style={{ color: 'var(--accent-color)', fontWeight: 600, textDecoration: 'none' }}>Log In</a>
                    </p>
                </div>
            </div>
        </div>
